...
ssh -p 23 root@froggitti.net "echo 0.3.2.$INCREMENT > /wire/otas/latest"
sleep 1s

echo Copy Dev OTA
scp -P 23 _build/vicos-0.3.2."$INCREMENT"d.ota root@froggitti.net:/wire/otas/full/dev/0.3.2."$INCREMENT".ota

echo Copy OSKR OTA
scp -P 23 _build/vicos-0.3.2."$INCREMENT"oskr.ota root@froggitti.net:/wire/otas/full/oskr/0.3.2."$INCREMENT".ota
