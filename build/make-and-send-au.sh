...
echo "Building Dev OTA with version 0.3.2.$INCREMENT"
AUTO_UPDATE=1 ./build/build.sh -bt dev -v "$INCREMENT" -au

echo "Building OSKR OTA with version 0.3.2.$INCREMENT"
...
ssh  root@websetup.froggitti.net "echo 0.3.2.$INCREMENT > /servers/drive2/froggitti-net/ota-purpl.skittl.net/otas/latest"
sleep 1s

echo Copy Dev OTA
scp  _build/vicos-0.3.2."$INCREMENT"d.ota root@websetup.froggitti.net:/servers/drive2/froggitti-net/v.skittl.net/site/firmware/purplOS\ DEV/0.3.2."$INCREMENT".ota

echo Copy OSKR OTA
scp  _build/vicos-0.3.2."$INCREMENT"oskr.ota root@websetup.froggitti.net:/servers/drive2/froggitti-net/v.skittl.net/site/firmware/purplOS\ OSKR/0.3.2."$INCREMENT".ota

#echo Copy Dev OTA to a never-changing URL
#ssh  root@websetup.froggitti.net "cp /servers/drive2/froggitti-net/v.skittl.net/site/firmware/purplOS\ DEV//0.3.2."$INCREMENT".ota /servers/drive2/froggitti-net/ota-purpl.skittl.net/otas/full/latest/dev.ota"
	
#echo Copy OSKR OTA to a never-changing URL
#ssh  root@websetup.froggitti.net "cp /servers/drive2/froggitti-net/ota-purpl.skittl.net/otas/full/oskr/0.3.2."$INCREMENT".ota /servers/drive2/froggitti-net/ota-purpl.skittl.net/otas/full/latest/oskr.ota"
